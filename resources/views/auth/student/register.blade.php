...
@section('main')
    <div class="container">
        ...
        <form action="{{route('register_student_post')}}" method="POST">
            @csrf
            <div class="main-user-info">
                ...
                <div class="user-input-box">
                    ...
                    <input type="text" id="class_teacher" name="class_teacher" placeholder="Enter Class Teacher">
                </div>
                <div class="user-input-box">
            ...
            <div class="login">
                <p>Have an account? <a href="{{route('login_student')}}">Login</a></p>
            </div>
        </form>
    </div>
@endsection
